...
<style>
    ...
    .trn-form-group .form-control {
        width: 100%;
        font-size: .875rem;
    }

    .trn-form-group textarea.form-control {
        resize: vertical;
        min-height: 72px;
    }
        ...
        <div class="trn-header">
            <div>
                ...
                <p class="trn-subtitle">
                    ...
                    <?php echo date('d F Y, H:i'); ?> WIB &nbsp;&middot;&nbsp; <?php echo count($tournaments); ?>
                    tournament terdaftar
                </p>
            </div>
        ...
        <div class="trn-top-grid">
                ...
                <div class="trn-card-body">
                    <form method="POST">
                        ...
                        <div class="trn-form-group">
                            ...
                            <input type="number" name="max_participants" class="form-control" min="2" value="16"
                                required>
                        </div>
            ...
            <div class="trn-table-card">
                <div class="trn-table-header">
                    ...
                    <span style="font-size:.82rem;color:var(--text-muted);"><?php echo count($tournaments); ?>
                        data</span>
                </div>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($tournaments as $t):
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="participant-wrap">
                                            <div class="participant-nums">
                                                <span><?php echo $t['participants']; ?> /
                                                    <?php echo $t['max_participants']; ?></span>
                                                <span
                                                    style="color:var(--text-muted);font-size:.72rem;"><?php echo $fillPct; ?>%</span>
                                            </div>
                                    ...
                                    <td>
                                        <a href="?delete=<?php echo $t['id']; ?>" class="btn-del"
