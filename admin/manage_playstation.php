    ...
    <div class="container">
        ...
        <div class="ps-header">
            <div>
                ...
                <p class="ps-subtitle">
                    ...
                    <?php echo date('d F Y, H:i'); ?> WIB &nbsp;&middot;&nbsp; <?php echo count($psUnits); ?> unit
                    terdaftar
                </p>
            </div>
        ...
        <div class="ps-stats">
            ...
            <div class="ps-stat">
                ...
                <div class="ps-stat-body">
                    <div class="ps-stat-num">PS4: <?php echo $totalPS4; ?> &nbsp;/&nbsp; PS5: <?php echo $totalPS5; ?>
                    </div>
                ...
                <div class="ps-card-body">
                    <form method="POST">
                        ...
                        <div class="ps-form-group">
                            ...
                            <input type="text" name="name" class="form-control" placeholder="Contoh: PS5 &ndash; Unit 3"
                                required>
                        </div>
                        <div class="ps-form-group">
                        ...
                        <div class="ps-price-hint">
                            ...
                            Harga otomatis: PS4 = Rp <?php echo number_format(PS4_PRICE_PER_HOUR, 0, ',', '.'); ?>/jam
                            &nbsp;&middot;&nbsp;
                            PS5 = Rp <?php echo number_format(PS5_PRICE_PER_HOUR, 0, ',', '.'); ?>/jam
                        </div>
                        <button type="submit" name="add_ps" class="btn btn-primary"
                    ...
                    <tbody>
                        <?php foreach ($psUnits as $ps):
                            ...
                            <tr>
                                ...
                                <td><span class="ps-type-badge <?php echo $typeClass; ?>"><?php echo $ps['type']; ?></span>
                                </td>
                                <td><span
                                        class="st-badge <?php echo $stClass; ?>"><?php echo ucfirst($ps['status']); ?></span>
                                </td>
                                <td>
                                ...
                                <td class="revenue-cell">
                                    Rp&nbsp;<?php echo number_format($ps['total_revenue'], 0, ',', '.'); ?></td>
                                <td>
                                    <div class="action-cell">
                                        ...
                                        <a href="?delete=<?php echo $ps['id']; ?>" class="btn-delete"
