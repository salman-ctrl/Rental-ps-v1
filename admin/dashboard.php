    ...
    <div class="container">
        ...
        <div class="dash-stats">
            ...
            <div class="dash-stat">
                ...
                <div class="dash-stat-num sm">Rp <?php echo number_format($stats['revenue_month'], 0, ',', '.'); ?>
                </div>
                        ...
                        <?php foreach ($recentBookings as $b):
                            ...
                            <tr>
                                ...
                                <td style="white-space:nowrap;">
                                    <?php echo substr($b['start_time'], 0, 5); ?> &ndash;
                                    <?php echo substr($b['end_time'], 0, 5); ?>
                                </td>
                                <td style="font-weight:600;">Rp <?php echo number_format($b['total_price'], 0, ',', '.'); ?>
                                </td>
                                <td><span
